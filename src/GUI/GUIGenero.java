...
public class GUIGenero extends JDialog {
    ...
    public GUIGenero(Point posicao, Dimension dimensao) {
...
//-----------------------------  btnRetrieve ------------------------------------------
                ...
                if (tfID.getText().equals("")) {
                    ...
                    try {
                        ...
                        if (genero != null) { //se encontrou na lista
                            tfNOME.setText(String.valueOf(genero.getNomeGenero()));
        ...
        btnNext.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                int prox = daoGenero.autoIdGenero();
...
//-----------------------------  SAVE ------------------------------------------
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                genero.setIdGenero(Integer.valueOf(tfID.getText()));
                genero.setNomeGenero(String.valueOf(tfNOME.getText()));
        ...
        btnList.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                acao = "list";
//                GUIGeneroListagem guiGeneroListagem = new GUIGeneroListagem(daoGenero.listInOrderNome(), getBounds().x, getBounds().y, dimensao);
            }
        });
        ...
        btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null,
                        "Confirma a exclusão do registro <ID = " + genero.getNomeGenero()+ ">?", "Confirm",
    ...
    public static void main(String[] args) {
        new GUIGenero(new Point(880, 250), new Dimension(800, 600));
    }
}
