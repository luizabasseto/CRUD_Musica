...
public class GUIInstrumentos extends JDialog {
    ...
    public GUIInstrumentos(Point posicao, Dimension dimensao) {
        setTitle("CRUD - Instrumentos");
...
//-----------------------------  btnRetrieve ------------------------------------------
        btnRetrieve.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (tfID.getText().equals("")) {
                    List<String> listaAuxiliar = daoInstrumentos.listInOrderNomeStrings("id");
                    ...
                    try {
                        instrumentos.setIdInstrumentos(Integer.valueOf(tfID.getText()));
                        instrumentos = daoInstrumentos.obter(instrumentos.getIdInstrumentos());
                        if (instrumentos != null) { //se encontrou na lista
                            tfNOME.setText(String.valueOf(instrumentos.getNomeInstrumentos()));
        ...
        btnNext.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                int prox = daoInstrumentos.autoIdInstrumentos();
...
//-----------------------------  SAVE ------------------------------------------
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                instrumentos.setIdInstrumentos(Integer.valueOf(tfID.getText()));
                instrumentos.setNomeInstrumentos(String.valueOf(tfNOME.getText()));

                if (!deuRuim) {
                    if (acao.equals("insert")) {
                        daoInstrumentos.inserir(instrumentos);
                        labelAviso.setText("Registro inserido.");
                    } else {
                        daoInstrumentos.atualizar(instrumentos);
        ...
        btnList.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                acao = "list";
//                GUIInstrumentosListagem guiInstrumentosListagem = new GUIInstrumentosListagem(daoInstrumentos.listInOrderNome(), getBounds().x, getBounds().y, dimensao);
            }
        });
        ...
        btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null,
                        "Confirma a exclusão do registro <ID = " + instrumentos.getNomeInstrumentos() + ">?", "Confirm",
                        JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)) {
                    labelAviso.setText("Registro excluído...");
                    daoInstrumentos.remover(instrumentos);
                    zerarAtributos();
                    mostrarBotoes(true);
                    atvBotoes(false, true, false, false);
                    tfNOME.requestFocus();
    ...
    public static void main(String[] args) {
        new GUIInstrumentos(new Point(880, 250), new Dimension(800, 600));
    }
}
