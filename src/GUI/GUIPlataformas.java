...
public class GUIPlataformas extends JDialog {
    ...
    public GUIPlataformas(Point posicao, Dimension dimensao) {
        setTitle("CRUD - Plataformas");
...
//-----------------------------  btnRetrieve ------------------------------------------
        btnRetrieve.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (tfID.getText().equals("")) {
                    List<String> listaAuxiliar = daoPlataformas.listInOrderNomeStrings("id");
                    ...
                    try {
                        plataformas.setIdPlataformas(Integer.valueOf(tfID.getText()));
                        plataformas = daoPlataformas.obter(plataformas.getIdPlataformas());
                        if (plataformas != null) { //se encontrou na lista
                            tfNOME.setText(String.valueOf(plataformas.getNomePlataformas()));
        ...
        btnNext.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                int prox = daoPlataformas.autoIdPlataformas();
...
//-----------------------------  SAVE ------------------------------------------
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                plataformas.setIdPlataformas(Integer.valueOf(tfID.getText()));
                plataformas.setNomePlataformas(String.valueOf(tfNOME.getText()));

                if (!deuRuim) {
                    if (acao.equals("insert")) {
                        daoPlataformas.inserir(plataformas);
                        labelAviso.setText("Registro inserido.");
                    } else {
                        daoPlataformas.atualizar(plataformas);
        ...
        btnList.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                acao = "list";
                GUIPlataformasListagem guiPlataformasListagem = new GUIPlataformasListagem(daoPlataformas.listInOrderNome(), getBounds().x, getBounds().y, dimensao);
            }
        });
        ...
        btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null,
                        "Confirma a exclusão do registro <ID = " + plataformas.getNomePlataformas() + ">?", "Confirm",
                        JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)) {
                    labelAviso.setText("Registro excluído...");
                    daoPlataformas.remover(plataformas);
                    zerarAtributos();
                    mostrarBotoes(true);
                    atvBotoes(false, true, false, false);
                    tfNOME.requestFocus();
    ...
    public static void main(String[] args) {
        new GUIPlataformas(new Point(880, 250), new Dimension(800, 600));
    }
}
