...
public class GUICantores extends JDialog {

    ImageIcon iconeCreate = new ImageIcon(getClass().getResource("/icones/create.png"));
    ImageIcon iconeNext = new ImageIcon(getClass().getResource("/icones/next.png"));
    ImageIcon iconeRetrieve = new ImageIcon(getClass().getResource("/icones/find.png"));
    ...
    public GUICantores(Point posicao, Dimension dimensao) {
        setTitle("CRUD - Cantores");
        setSize(dimensao);//tamanho da janela
        setLayout(new BorderLayout());//informa qual gerenciador de layout será usado
        setBackground(new Color(255, 0, 0));//cor do fundo da janela
...
//atritubos não chave, todos no painel centro
        ...
        tfID.requestFocus();
        tfID.selectAll();
        labelAviso.setText("Digite um Cpf e clic [Pesquisar]");
...
//-----------------------------  btnRetrieve ------------------------------------------
        btnRetrieve.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                cantores = new Cantores();
                tfID.setText(tfID.getText().trim());//caso tenham sido digitados espaços

                if (tfID.getText().equals("")) {
                    List<String> listaAuxiliar = daoCantores.listInOrderNomeStrings("id");
                    ...
                    try {
                        cantores.setIdCantores(Integer.valueOf(tfID.getText()));
                        cantores = daoCantores.obter(cantores.getIdCantores());
                        if (cantores != null) { //se encontrou na lista
                            tfNOME.setText(String.valueOf(cantores.getNomeCantores()));
        ...
        btnNext.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                int prox = daoCantores.autoIdCantores();
...
//-----------------------------  SAVE ------------------------------------------
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                cantores.setIdCantores(Integer.valueOf(tfID.getText()));
                cantores.setNomeCantores(String.valueOf(tfNOME.getText()));
                ...
                if (!deuRuim) {
                    if (acao.equals("insert")) {
                        ...
                        daoCantores.atualizar(cantores);
        ...
        btnList.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                acao = "list";
                GUICantoresListagem guiCantoresListagem = new GUICantoresListagem(daoCantores.listInOrderNome(), getBounds().x, getBounds().y, dimensao);
            }
        });
        ...
        btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null,
                        "Confirma a exclusão do registro <ID = " + cantores.getNomeCantores() + ">?", "Confirm",
...
// ----------------   Janela Pesquisar para FKs -----------------
    ...
    public static void main(String[] args) {
        new GUICantores(new Point(880, 250), new Dimension(800, 600));
    }
}
