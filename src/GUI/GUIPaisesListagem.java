...
// @author luiza
public class GUIPaisesListagem extends JDialog {
    ...
    public GUIPaisesListagem(List<Paises> texto, int posX, int posY, Dimension dimensao) {
        setTitle("Listagem de Paises");
        ...
        String[] colunas = new String[]{"idPaises",
            "nomePaises",};
        ...
        for (int i = 0; i < texto.size(); i++) {
            String[] linha = new String[]{String.valueOf(texto.get(i).getIdPaises()),
                String.valueOf(texto.get(i).getNomePaises()),};
            model.addRow(linha);
        }
